...
export function CardDemo() {
    return <div>
        <h2 class="umd-type--display-1">Cards</h2>
        <div>
            <h3 class="umd-type--headline">Simple</h3>
            <Card>
        ...
        <div>
            <h3 class="umd-type--headline">Actions</h3>
        ...
        <div>
            <h3 class="umd-type--headline">Media</h3>
            <Card>
                <CardMedia>
        ...
        <div>
            <h3 class="umd-type--headline">Media Area</h3>
            <Card>
